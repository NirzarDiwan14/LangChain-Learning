...
class Schema(BaseModel):
    ...
    specs: list[str] = Field(description="must write down all the key specifications discussed in a review in a list")
    summary: str = Field(description="mmust write down a brief summary of review.")
    sentiment: Literal["positive","negative"]= Field(description="must return a sentiment of the review.")
    specs: Optional[list[str]] = Field(default = None ,description="write down all the pros inside the list if any.")
    specs: Optional[list[str]] = Field(default = None ,description="write down all the cons inside the list if any.")
